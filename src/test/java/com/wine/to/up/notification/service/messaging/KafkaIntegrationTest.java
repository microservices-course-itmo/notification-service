...
public class KafkaIntegrationTest {
    ...
    @KafkaListener(id = "test-user-service-topic-listener", topics = {"wine-response-topic"}, containerFactory = "singleFactory")
    public void consumer(WinePriceUpdatedResponse winePriceUpdatedResponse){
        if(winePriceUpdatedResponse.getWineName().equals("integration test"))testPassed=true;
    }
}
